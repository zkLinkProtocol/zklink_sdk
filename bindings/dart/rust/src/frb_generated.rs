...
mod io {
    ...
    impl
        CstDecode<RustOpaqueNom<flutter_rust_bridge::for_generated::RustAutoOpaqueInner<Parameter>>>
        for usize
    {
        // Codec=Cst (C-struct based), see doc to use other codecs
        fn cst_decode(
    ...
    pub extern "C" fn frbgen_zklink_wire__crate__api__Signer_starknet_signer(
        ...
        wire__crate__api__Signer_starknet_signer_impl(
            eth_private_key,
            starknet_chain_id,
            starknet_addr,
        )
    ...
    pub extern "C" fn frbgen_zklink_wire__crate__api__UpdateGlobalVar_new(
        ...
        wire__crate__api__UpdateGlobalVar_new_impl(
            from_chain_id,
            sub_account_id,
            parameter,
            serial_id,
