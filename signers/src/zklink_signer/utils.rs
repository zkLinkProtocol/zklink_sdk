...
mod tests {
    ...
    fn test_rescue_hash_tx_msg() {
        ...
        assert_eq!(
            hash,
            vec![
                249, 154, 208, 123, 96, 89, 132, 235, 231, 63, 56, 200, 153, 131, 27, 183, 128, 71, 26, 245, 208, 120,
                49, 246, 233, 72, 230, 84, 66, 150, 170, 27
            ]
        );
    }
    ...
    fn test_rescue_hash_orders() {
        ...
        assert_eq!(
            hash,
            vec![
                165, 52, 198, 24, 171, 190, 215, 122, 29, 12, 31, 190, 98, 145, 72, 245, 89, 202, 199, 73, 239, 213,
                234, 218, 74, 182, 95, 119, 141, 75, 253
            ]
        );
    }
}
